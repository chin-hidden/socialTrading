INSERT INTO account (account_number, username, password, name, cash, account_type, broker) VALUES
       ...
       ('account-of-trader-01', 'trader01', 'password', 'Xin Một Lần Thua', 4500000, 'TRADER', 'VNDIRECT');
...
INSERT INTO transaction VALUES
	...
	('second-transaction', 'demo_user', 'trader01', 'VND', 10, 23000, 'now', 'NS', 'MP', 23200, 10, 'Filled'),
	('third-transaction', 'demo_user', 'trader01', 'ACB', 40, 30000, 'now', 'NB', 'MP', 31000, 40, 'Filled');

INSERT INTO deal (buying_order_id, selling_order_id) VALUES
	('third-transaction', NULL),
	('third-transaction', NULL),
	('third-transaction', NULL),
	('third-transaction', NULL),
	('third-transaction', NULL),
