...
(['scripts/wizardapp'], function(System) {
...
System.register("github:kenwheeler/slick@1.5.8/slick/slick", [], false, function(__require, __exports, __module) {
  System.get("@@global-helpers").prepareGlobal(__module.id, []);
  (function() {
    "format global";
    (function(factory) {
...
System.register("github:kenwheeler/slick@1.5.8", ["github:kenwheeler/slick@1.5.8/slick/slick"], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  module.exports = require("github:kenwheeler/slick@1.5.8/slick/slick");
  global.define = __define;
  return module.exports;
});
...
System.register("scripts/wizardScreen", ["npm:react@0.14.0-beta3", "npm:underscore@1.8.3", "github:components/jquery@2.1.4", "github:kenwheeler/slick@1.5.8", "github:kenwheeler/slick@1.5.8/slick/slick.css!github:systemjs/plugin-css@0.1.13", "scripts/common", "scripts/utils", "scripts/Slider"], function (_export) {
    "use strict";

    var React, _, $, slick, me, traders, formatCurrency, getMarketInfo, formatPercent, RiskSlider, MoneySlider, WizardScreen, TraderCarousel, TraderLine;
    ...
    return {
        setters: [function (_npmReact0140Beta3) {
        ...
        }, function (_githubKenwheelerSlick158) {
            slick = _githubKenwheelerSlick158["default"];
        }, function (_githubKenwheelerSlick158SlickSlickCssGithubSystemjsPluginCss0113) {}, function (_scriptsCommon) {
            ...
            MoneySlider = _scriptsSlider.MoneySlider;
        }],
        execute: function () {
            WizardScreen = React.createClass({
                ...
                returnToAccountScreen: function returnToAccountScreen() {
                ...
                render: function render() {
                    ...
                    return React.createElement(
                        "div",
                        { className: "panel panel-vndirect wizard" },
                        React.createElement(
                            "div",
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "h3",
                                    null,
                                    "Bước 1: Đặt khoản tiền đầu tư của bạn tại Autotrade:"
                                ),
                                React.createElement(
                                    "p",
                                    null,
                                    "Số tiền tối đa có thể đặt: ",
                                    formatCurrency(me.get("cash"))
                                ),
                                React.createElement(MoneySlider, { config: moneySliderConfig })
                            ),
                            React.createElement(
                                "div",
                                { className: "step" },
                                React.createElement(
                                    "h3",
                                    null,
                                    "Bước 2: Lựa chọn chiến lược gia bạn muốn sao chép:"
                                ),
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    "h3",
                                    null,
                                    "Bước 3: Đặt mức độ rủi ro bạn sẵn sàng chấp nhận:"
                                ),
                                React.createElement(RiskSlider, { ref: "riskSlider", config: riskSliderConfig }),
                                React.createElement(
                                    "p",
                                    null,
                                ...
                                React.createElement(
                                    ...
                                    " Mức độ rủi ro cao có thể mang lại cho bạn khoản lãi lớn hơn nhưng nguy cơ lỗ cũng cao hơn."
                                )
                            ),
                            React.createElement(
                                "div",
            ...
            _export("WizardScreen", WizardScreen);

            // FIXME Using global `traders` object
            TraderCarousel = React.createClass({
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                formatCurrency(this.props.trader.get("nav"))
                            ),
                            ...
                            React.createElement(
                                "strong",
                                { className: "text-success" },
                                this.props.trader.get("people_following")
                            ),
                            React.createElement("br", null),
                            React.createElement(
                                "span",
                            ...
                            React.createElement(
                                "strong",
                                { className: "text-success" },
                                formatPercent(this.props.trader.get('roi') / 100)
                            )
                        )
                    );
                }
...
System.register("scripts/wizardapp", ["scripts/csrf", "scripts/wizardScreen", "scripts/common", "npm:react@0.14.0-beta3"], function (_export) {
    "use strict";

    var WizardScreen, loadData, React;
    return {
        setters: [function (_scriptsCsrf) {}, function (_scriptsWizardScreen) {
            WizardScreen = _scriptsWizardScreen.WizardScreen;
        ...
        execute: function () {
            ...
            loadData().then(function () {
                React.render(React.createElement(WizardScreen, null), document.getElementById('app'));
            });
        }
    };
});
System.register('github:kenwheeler/slick@1.5.8/slick/slick.css!github:systemjs/plugin-css@0.1.13', [], false, function() {});
...
(".slick-list,.slick-slider,.slick-track{display:block;position:relative}.slick-loading .slick-slide,.slick-loading .slick-track{visibility:hidden}.noUi-base,.noUi-target,.slick-list,.slick-slider,.slick-track{position:relative}.slick-slider{-moz-box-sizing:border-box;box-sizing:border-box;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;-webkit-touch-callout:none;-khtml-user-select:none;-ms-touch-action:pan-y;touch-action:pan-y;-webkit-tap-highlight-color:transparent}.slick-list{overflow:hidden;margin:0;padding:0}.slick-list:focus{outline:0}.slick-list.dragging{cursor:pointer;cursor:hand}.slick-slider .slick-list,.slick-slider .slick-track{-webkit-transform:translate3d(0,0,0);-moz-transform:translate3d(0,0,0);-ms-transform:translate3d(0,0,0);-o-transform:translate3d(0,0,0);transform:translate3d(0,0,0)}.slick-track{top:0;left:0}.slick-track:after,.slick-track:before{display:table;content:''}.slick-track:after{clear:both}.slick-slide{display:none;float:left;height:100%;min-height:1px}[dir=rtl] .slick-slide{float:right}.slick-slide img{display:block}.slick-slide.slick-loading img{display:none}.slick-slide.dragging img{pointer-events:none}.slick-initialized .slick-slide{display:block}.slick-vertical .slick-slide{display:block;height:auto;border:1px solid transparent}.slick-arrow.slick-hidden{display:none}.noUi-target,.noUi-target *{-webkit-touch-callout:none;-webkit-user-select:none;-ms-touch-action:none;-ms-user-select:none;-moz-user-select:none;-moz-box-sizing:border-box;box-sizing:border-box}.noUi-target{direction:ltr}.noUi-base{width:100%;height:100%;z-index:1;-webkit-transform:translate3d(0,0,0);transform:translate3d(0,0,0)}.noUi-origin{position:absolute;right:0;top:0;left:0;bottom:0;border-radius:2px}.noUi-handle{position:relative;z-index:1}.noUi-stacking .noUi-handle{z-index:10}.noUi-state-tap .noUi-origin{-webkit-transition:left .3s,top .3s;transition:left .3s,top .3s}.noUi-state-drag *{cursor:inherit!important}.noUi-horizontal{height:18px}.noUi-horizontal .noUi-handle{width:34px;height:28px;left:-17px;top:-6px}.noUi-vertical{width:18px}.noUi-vertical .noUi-handle{width:28px;height:34px;left:-6px;top:-17px}.noUi-background{background:#FAFAFA;box-shadow:inset 0 1px 1px #f0f0f0}.noUi-connect{background:#3FB8AF;box-shadow:inset 0 0 3px rgba(51,51,51,.45);-webkit-transition:background 450ms;transition:background 450ms}.noUi-target{border-radius:4px;border:1px solid #D3D3D3;box-shadow:inset 0 1px 1px #F0F0F0,0 3px 6px -5px #BBB}.noUi-target.noUi-connect{box-shadow:inset 0 0 3px rgba(51,51,51,.45),0 3px 6px -5px #BBB}.noUi-dragable{cursor:w-resize}.noUi-vertical .noUi-dragable{cursor:n-resize}.noUi-handle{border:1px solid #D9D9D9;border-radius:3px;background:#FFF;cursor:default;box-shadow:inset 0 0 1px #FFF,inset 0 1px 7px #EBEBEB,0 3px 6px -3px #BBB}.noUi-active{box-shadow:inset 0 0 1px #FFF,inset 0 1px 7px #DDD,0 3px 6px -3px #BBB}.noUi-handle:after,.noUi-handle:before{content:\"\";display:block;position:absolute;height:14px;width:1px;background:#E8E7E6;left:14px;top:6px}.noUi-handle:after{left:17px}.noUi-vertical .noUi-handle:after,.noUi-vertical .noUi-handle:before{width:14px;height:1px;left:6px;top:14px}.noUi-vertical .noUi-handle:after{top:17px}[disabled] .noUi-connect,[disabled].noUi-connect{background:#B8B8B8}[disabled] .noUi-handle,[disabled].noUi-origin{cursor:not-allowed}");
(function() {
  var loader = System;
