define(["exports", "module", "common"], function (exports, module, _common) {
    "use strict";
    ...
    var RiskSlider = (function (_React$Component) {
        _inherits(RiskSlider, _React$Component);
        ...
        _createClass(RiskSlider, [{
            ...
            value: function componentDidMount() {
                ...
                var tmp = $(slider).noUiSlider({
                    start: [_common.me.get("riskFactor")],
                    step: 10,
                    connect: "lower",
                    range: {
                        'min': [0],
    ...
    module.exports = RiskSlider;
});
//# sourceMappingURL=RiskSlider.js.map