...
def follower_positions(username):
    ...
    return map(make_serializer(["id", "username", "mimicking_username",
        "buying_price", "selling_price", "quantity", "status", "buying_date", "symbol", 'profit', 'roi']), deals)
...
def get_all_traders():
    ...
    Return all traders
    """
    fields = ['id', 'name', 'username', 'account_type', 'account_number', 'description', 'cash', 'people_following', 'total_allocated_money', 'follower_roi', 'nav']
